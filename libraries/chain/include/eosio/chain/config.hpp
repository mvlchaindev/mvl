...
const static uint64_t system_account_name    = N(mvl);
const static uint64_t null_account_name      = N(mvl.null);
const static uint64_t producers_account_name = N(mvl.prods);
...
const static uint64_t eosio_auth_scope       = N(mvl.auth);
const static uint64_t eosio_all_scope        = N(mvl.all);

const static uint64_t active_name = N(active);
const static uint64_t owner_name  = N(owner);
const static uint64_t eosio_any_name = N(mvl.any);
const static uint64_t eosio_code_name = N(mvl.code);
